...
<?php elseif ( in_array( $akismet_user->status, array( 'missing', 'no-sub' ) ) ) : //no akismet account, ask do they want to use jetpack wpcom account to create one, then redirect to plans page?>
