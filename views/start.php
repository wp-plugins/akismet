...
<div class="activate-highlight activate-option">
	...
	<form name="akismet_use_wpcom_key" action="<?php echo Akismet_Admin::get_page_url();?>" method="post" id="akismet-activate" class="right">
		...
		<input type="submit" class="button button-primary" value="<?php esc_attr_e( 'Use this Akismet account' ); ?>"/>
	</form>
</div>
<div class="activate-highlight secondary activate-option">
	<div class="option-description">
		<strong><?php esc_html_e('Create a new API key with a different email address'); ?></strong>
		<p><?php esc_html_e('Use this option if you want to setup a new Akismet account.'); ?></p>
	</div>
...
<p><?php esc_html_e('Akismet eliminates the comment and trackback spam you get on your site. Register your email address below to get started.'); ?></p>
<div class="activate-highlight activate-option">
	<div class="option-description">
		<strong class="small-heading"><?php esc_html_e('Connected via Jetpack'); ?></strong>
		<?php echo esc_attr( $akismet_user->user_email ); ?>
	...
	<form name="akismet_activate" id="akismet_activate" action="https://akismet.com/get/" method="post" class="right"> 
		...
		<input type="submit" class="button button-primary" value="<?php esc_attr_e( 'Register Akismet' ); ?>"/>
	</form>
</div>
<div class="activate-highlight secondary activate-option">
	<div class="option-description">
...
<p><?php esc_html_e('Akismet eliminates the comment and trackback spam you get on your site.'); ?></p>
<div class="activate-highlight centered activate-option">
	<strong class="small-heading"><?php esc_html_e( 'Connected via Jetpack' ); ?></strong>
	<h3 class="alert-text" s><?php printf( esc_html__( 'Your subscription for %s is suspended' ), $akismet_user->user_email ); ?></h3>
...
<div class="activate-highlight activate-option">
	<div class="option-description">
		<strong><?php esc_html_e( 'New to Akismet?' );?></strong>
		<p><?php esc_html_e('Get started now to squash the comment and trackback spam you get.'); ?></p>
	</div>
